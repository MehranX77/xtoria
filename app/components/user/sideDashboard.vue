<template>
    <UDashboardSidebar :ui="{ footer: 'border-t border-default', root: 'border mt-2 rounded-lg max-h-dvh min-h-[90dvh]'}">
        ...
        <template #default>
            <UNavigationMenu :highlight="true" color="neutral" variant="link"  :items="items[0]" orientation="vertical" dir="rtl" :ui="{item:'border-b border-b-slate-200', linkLabel:'my-2 text-md/tight font-stretch-50% ' , linkLeadingIcon:'lg:text-lg/tight text-md/tight'}"/>
