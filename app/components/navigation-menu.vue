  ...
  <template #fallback>
    <USkeleton class="h-12 w-40 rounded-xl self-center bg-slate-200/85 dark:bg-slate-700/85"/>
      ...
      <div class="logo transition-all basis-7xl self-center">
        ...
        <UNavigationMenu content-orientation="horizontal" :unmount-on-hide="true" :items="items"
          class="transition-all w-[60%] mx-auto justify-center mt-4" :class="{ 'mt-0': res }"
          :ui="{ linkLabel: 'text-md', linkLeadingIcon: 'text-md', childList: 'grid grid-cols-3', childLink: 'text-md' }" />
      </div>
